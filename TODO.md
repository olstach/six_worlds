...
- [ ] **`special` is standardised in shape but not yet in content.**
  ...
  note 3, dispel_battlefield 1, see_through_stealth 1, apply_status 1); **205
  spells still carry a `legacy` block**, and **361 legacy keys** are frozen.
  ...
  **The per-spell worklist is `docs/review/SPELL_FIXES.md`**, generated by
  ...
  |---|---:|---|
  | A — mechanical | 8 | Key routes to a type and carries its value. No decisions. |
  | B — wrong field | 13 | Fact is fine; belongs on the summon template, the targeting block, or nowhere. |
