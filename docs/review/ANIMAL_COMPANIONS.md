...
<!--@ companions.json | anavatapta | flavor_text -->
Forty years of naga court administration and not one raised voice. He can find the sentence that ends an argument, and he has never once enjoyed using it.
<!--@end-->
...
<!--@ companions.json | minakshi | flavor_text -->
Dances the shoal-turns that keep a school alive — a thousand bodies changing direction as one. Out of the water she is merely extraordinary.
<!--@end-->
...
<!--@ companions.json | phenaka | flavor_text -->
Carries messages up and down four hundred miles of coast and knows every waypoint, every teahouse, and everyone's business. Delivers all of it, whether or not it was the message.
<!--@end-->
...
<!--@ companions.json | setubandha | flavor_text -->
Walks the line between salt and fresh, deep and shallow, this realm and the next. Claims the boundaries are the only places where anything real happens.
<!--@end-->
...
<!--@ companions.json | shesharati | flavor_text -->
Reads the tide the way other people read faces, and has stopped pretending this is a metaphor. She left the palace because the court wanted prophecies and she only had weather.
<!--@end-->
...
<!--@ companions.json | timingila | flavor_text -->
Hunts alone in water where the light does not reach. Speaks rarely and with long pauses, as though surfacing between each sentence.
<!--@end-->
